...
"color:rgb(204,204,204);"));
        store_data_click = new QPushButton(nav_bar);
        store_data_click->setObjectName(QString::fromUtf8("store_data_click"));
        store_data_click->setGeometry(QRect(0, 170, 150, 41));
...
"color: rgb(255, 255, 255);"));
    ...
    void retranslateUi(QWidget *BackStage)
    {
        ...
        store_data_click->setText(QCoreApplication::translate("BackStage", "\344\277\235\345\255\230\346\225\260\346\215\256", nullptr));
